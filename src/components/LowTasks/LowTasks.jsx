...
export default function LowTasks() {

  const tasks = useSelector((state)=> state.tasks)
  const HighTasks = tasks.filter((task)=> task.importantce == 'low')
  ...
  return (
    ...
    <div className='tasks p-12 flex p-0  flex-wrap gap-10 bg-yellow-100'>
